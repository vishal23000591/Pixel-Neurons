...
# Enable CORS for the entire app (allow all origins)
CORS(app, resources={r"/*": {"origins": "*"}})  # Here CORS is applied globally

# Sets an environment variable GOOGLE_API_KEY with a specified API key.
os.environ["GOOGLE_API_KEY"] = "AIzaSyCxtT98s9zJ8jQ-3csEeubZnUwLIX0t4HQ"
